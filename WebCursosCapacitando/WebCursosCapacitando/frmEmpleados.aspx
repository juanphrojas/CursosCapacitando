            ...
            <asp:Panel ID="PanelInfo" runat="server">
                <table align="center" cellpadding="0" cellspacing="0" class="auto-style4">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtAntiguedad" runat="server" Height="20px" Width="269px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        <td colspan="2" style="text-align: center">
                            <asp:Button ID="btnAddEmpleado" runat="server" BackColor="#00FF99" BorderColor="#00B96F" BorderStyle="None" CssClass="nuevoEstilo2" Font-Bold="True" ForeColor="#002847" Height="47px" Text="Resgistrar Empleado" Width="200px" />
                        </td>
                        <td colspan="2" style="text-align: center">
