...
namespace WebCursosCapacitando
{
    class clsTema
    {
        ...
        public clsTema(string Aplicacion, string _Nombre, string _Descripcion)
        {
            Nombre = _Nombre;
        ...
        public bool BuscarTema(int _Codigo)
        {
            try
            {
                strSQL = "exec USP_TEMa_BuscarXCodigo '" + _Codigo + "';";
        ...
        public bool Insertar()
        {
            try
            {
                if (!ValidarDatos())
                    return false;
                strSQL = "exec USP_TEMa_Grabar '" + Nombre + "','" + Descripcion + "';";
                if (!Grabar())
                    return false;
        ...
        public bool Modificar()
        {
            try
            {
                ...
                if (!ValidarModificar())
                    return false;
                strSQL = "exec USP_TEMa_Modificar '" + Codigo + "','" + Nombre + "','" + Descripcion + "';";
                return Grabar();
            }
            catch (Exception ex)
            {
        ...
        public bool LlenarGrid(GridView grid)
        {
            try
            {
                ...
                strSQL = "exec USP_TEMa_BuscarGeneral;";
