...
namespace WebCursosCapacitando
{
    public class clsCliente
    {
        ...
        public clsCliente(string Aplicacion, string _Cedula, string _Nombre, string _Apellido, int _Empleado)
        {
            Codigo = 0;
            Cedula = _Cedula;
            Nombre = _Nombre;
        ...
        public bool BuscarCliente(int _Codigo, GridView grid)
        {
            try
            {
